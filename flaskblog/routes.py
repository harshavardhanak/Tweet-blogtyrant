...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            flash('Login was unsuccessfyll. Please check email and password', 'danger')
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your account has created and you can login now !!', 'success')
        return redirect(url_for('home'))
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request', 
                    sender='harshavardhanakhv@gmail.com', 
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your password has been updated and you can login now !!', 'success')
        return redirect(url_for('home'))
